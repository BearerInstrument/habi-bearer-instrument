...
| Python prototype reproducing counterexamples | Kept alongside the Rust port per README ("structurally identical... same modules, same invariants, same demo/test scenarios") — confirm it still runs cleanly before citing test output from it |
