...
| Independent Coq mechanization, 10 machine-checked theorems | `habi_safety.v` (406 lines) — theorem names follow `naive_reconnect_*`, `safe_reconnect_*`, `reconnect_*_double_spend` patterns; compiles cleanly (`coqc` exit 0). Note: this proof was not re-run as part of the 2026-09-15 verification pass below and should be independently reconfirmed before being cited further. |
